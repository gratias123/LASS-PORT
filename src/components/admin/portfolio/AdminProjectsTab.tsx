                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1">
                    <div>
                      ...
                      <p className="text-[11px] text-slate-400 mt-0.5">
                        Téléversez la véritable capture d’écran de la plateforme. Elle devient automatiquement la couverture du projet public.
                      </p>
                    </div>
                        ...
                        {hasCover ? (
                          ...
                          <div className="text-center p-4">
                            ...
                            <span className="text-[10px] text-slate-500">
                              (Le portfolio affiche : « Visuel du projet à ajouter »)
                            </span>
                          </div>
                        )}
                    ...
                    <div className="md:col-span-7 space-y-3">
                      <div>
                        <span className="text-[11px] font-semibold text-slate-300 block mb-1">
                          Option 1 : Téléverser une capture d'écran (ordinateur ou mobile)
                        </span>
                        <div className="flex items-center gap-2">
                          <label className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-blue-600 hover:bg-blue-500 text-white text-xs font-semibold cursor-pointer shadow-sm transition-all">
                            ...
                            <span>{hasCover ? "Remplacer l'image" : 'Ajouter une image'}</span>
                            <input
                              type="file"
                              accept="image/*"
                              className="hidden"
                          ...
                          {hasCover && (
                            <button
                              type="button"
                              onClick={() => updateProject(proj.id, { imageUrl: '' })}
                              className="px-3 py-2 rounded-xl bg-slate-800 hover:bg-red-950/60 hover:text-red-400 text-slate-400 border border-slate-700 text-xs font-medium transition-colors cursor-pointer flex items-center gap-1.5"
                            >
                              <Trash2 className="w-3.5 h-3.5" />
