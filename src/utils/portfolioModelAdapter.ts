...
export const SEMAKO_MODEL_DATA: CustomPortfolioData = {
  ...
  skills: [
    { id: 'skill-im-1', name: 'Dépannage des postes de travail & remplacement de composants', category: 'Informatique & Maintenance', levelOrDesc: '' },
    { id: 'skill-im-2', name: 'Installation et configuration des systèmes Windows & Linux', category: 'Informatique & Maintenance', levelOrDesc: '' },
    { id: 'skill-im-3', name: 'Diagnostic matériel & logiciel des ordinateurs', category: 'Informatique & Maintenance', levelOrDesc: '' },
    { id: 'skill-im-4', name: 'Réalisation de câblages réseau RJ45 & tests de connectivité', category: 'Informatique & Maintenance', levelOrDesc: '' },
    { id: 'skill-im-5', name: 'Maintenance préventive & nettoyage physique des parcs', category: 'Informatique & Maintenance', levelOrDesc: '' },

    { id: 'skill-gsm-1', name: 'Diagnostic approfondi des pannes sur smartphones Android & iOS', category: 'Maintenance GSM', levelOrDesc: '' },
    { id: 'skill-gsm-2', name: 'Remplacement d’écrans tactiles & dalles LCD/OLED', category: 'Maintenance GSM', levelOrDesc: '' },
    { id: 'skill-gsm-3', name: 'Remplacement de batteries & connecteurs de charge USB-C', category: 'Maintenance GSM', levelOrDesc: '' },
    { id: 'skill-gsm-4', name: 'Désoxydation des circuits électroniques après immersion', category: 'Maintenance GSM', levelOrDesc: '' },
    { id: 'skill-gsm-5', name: 'Utilisation d’équipements spécialisés (Station air chaud, multimètre)', category: 'Maintenance GSM', levelOrDesc: '' },

    { id: 'skill-dg-1', name: 'Conception d’affiches, flyers & supports de communication', category: 'Design Graphique', levelOrDesc: '' },
    { id: 'skill-dg-2', name: 'Retouche avancée, détourage et traitement d’images', category: 'Design Graphique', levelOrDesc: '' },
    { id: 'skill-dg-3', name: 'Élaboration de chartes graphiques & identités de marques', category: 'Design Graphique', levelOrDesc: '' },
    { id: 'skill-dg-4', name: 'Sérigraphie artisanale sur textiles & supports papier', category: 'Design Graphique', levelOrDesc: '' },
    { id: 'skill-dg-5', name: 'Prototypage d’interfaces ergonomiques et intuitives (UI/UX)', category: 'Design Graphique', levelOrDesc: '' },

    { id: 'skill-od-1', name: 'Adobe Photoshop & Photopea', category: 'Outils de Design', levelOrDesc: '' },
    { id: 'skill-od-2', name: 'Figma & Adobe XD', category: 'Outils de Design', levelOrDesc: '' },
    { id: 'skill-od-3', name: 'Canva Pro', category: 'Outils de Design', levelOrDesc: '' },

    { id: 'skill-owl-1', name: 'Visual Studio Code', category: 'Outils Web & Logiciels', levelOrDesc: '' },
    { id: 'skill-owl-2', name: 'HTML5, CSS3 & JavaScript', category: 'Outils Web & Logiciels', levelOrDesc: '' },
    { id: 'skill-owl-3', name: 'Bootstrap & Tailwind CSS', category: 'Outils Web & Logiciels', levelOrDesc: '' },
    { id: 'skill-owl-4', name: 'Git, GitHub & GitHub Pages', category: 'Outils Web & Logiciels', levelOrDesc: '' },

    { id: 'skill-pe-1', name: 'Formulation et optimisation de prompts', category: 'Prompt Engineering', levelOrDesc: '' },
    { id: 'skill-pe-2', name: 'Structuration de contextes et d’instructions complexes', category: 'Prompt Engineering', levelOrDesc: '' },
    { id: 'skill-pe-3', name: 'Génération et adaptation de contenus textuels et visuels', category: 'Prompt Engineering', levelOrDesc: '' },
    { id: 'skill-pe-4', name: 'Automatisation de tâches répétitives assistée par IA', category: 'Prompt Engineering', levelOrDesc: '' },
    { id: 'skill-pe-5', name: 'Prototypage rapide de solutions numériques assisté par IA', category: 'Prompt Engineering', levelOrDesc: '' },
    { id: 'skill-pe-6', name: 'Utilisation raisonnée et responsable des outils d’IA', category: 'Prompt Engineering', levelOrDesc: '' },
  ],
  ...
  certifications: CERTIFICATIONS_LIST.map((cert) => ({
    ...
    availableOnDemand: cert.availableOnDemand || false,
  ...
  projects: {
    ...
    items: [
      ...
      {
        id: 'proj-4',
        name: 'Système de prompts & assistance à la création de contenus et prototypes',
        description:
          'Création d’un ensemble de prompts structurés et réutilisables pour accélérer la rédaction technique, concevoir des scénarios d’interfaces et assister la production visuelle et textuelle dans des contextes réels.',
        role: 'Prompt Engineer & Concepteur',
        period: '2024',
        tools: ['LLMs', 'Outils d’IA générative', 'Outils de prototypage', 'Figma'],
        results: 'Gain de temps, meilleure clarté des livrables et standardisation des requêtes pour des résultats exploitables.',
      },
    ],
  },
