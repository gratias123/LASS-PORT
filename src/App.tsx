    ...
    <PortfolioProvider value={portfolioContextValue}>
      <div className="min-h-screen flex flex-col bg-slate-50 text-slate-900 selection:bg-blue-600 selection:text-white w-full max-w-[100vw] overflow-x-hidden">
        ...
        <main className="flex-1">
          ...
          {/* Section 3: Compétences & Domaines d'expertise */}
          <SkillsSection />

          {/* Section 4: Projets & Réalisations (Pièce maîtresse) */}
          <ProjectsSection />

          {/* Section 5: Parcours & Expériences pratiques */}
          <PracticalExperiences />

          {/* Section 6: Cursus académique */}
          <AcademicCurriculum />

          {/* Section 7: Formations complémentaires */}
          <AdditionalTraining />

          {/* Section 8: Certifications & Diplômes vérifiés */}
          <CertificationsSection />

          {/* Section 9: Outils & Technologies */}
          <ToolsSection />

          {/* Section 10: Wikimedia & Engagement communautaire */}
          <WikimediaSection />

          {/* Section 11: Contact & Coordonnées */}
          <ContactSection />
        </main>
