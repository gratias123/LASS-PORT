...
const TRANSLATIONS: Record<Language, Record<string, string>> = {
  fr: {
    ...
    'projects.subtitle': 'Une sélection de réalisations techniques, graphiques et numériques.',
    'projects.viewProject': 'Voir le projet',
    'projects.viewDetails': 'Voir le projet',
    ...
    'tools.showMore': 'Voir plus d’outils',
    'tools.showLess': 'Voir moins',
  ...
  en: {
    ...
    'projects.subtitle': 'A selection of technical, graphic, and digital accomplishments.',
    ...
    'tools.showMore': 'Show more tools',
